          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <div>
              <div className="font-heading font-black text-black flex items-center gap-2 text-sm uppercase tracking-tight">
                Safe Slice Mandoline <span className="bg-black text-white text-[8px] uppercase font-bold px-2 py-0.5 rounded-full flex items-center gap-1 shadow-sm"><Zap size={8} fill="currentColor"/> SAVE {productData.discount}</span>
              </div>
            ...
            <button 
              ...
              className="bg-primary hover:bg-primary-hover border-b-4 border-black/20 active:border-b-0 active:translate-y-1 text-white font-black py-4 px-4 sm:px-6 rounded-xl shadow-xl flex-1 sm:flex-none transition-all flex flex-col items-center justify-center gap-0 animate-pulse whitespace-nowrap"
            >
              <span className="text-[13px] sm:text-[15px] uppercase tracking-wide leading-none">PEDIR CONTRA ENTREGA</span>
              <span className="text-[9px] uppercase font-bold opacity-80 mt-1">Envío Gratis</span>
            </button>
          </div>
