  ...
  const items = [
    {
      ...
      text: "Confiamos tanto en Zento que si no ves resultados en 30 días, te brindamos soporte personalizado."
    },
    {
      icon: Award,
      title: "Producto 100% Original",
      text: "Somos distribuidores oficiales. Garantizamos la fórmula secreta y activos de la más alta pureza."
    },
    {
      icon: Truck,
      title: "Envíos Seguros",
      text: "Tu pedido viaja asegurado cargado de cuidado para que llegue intacto a la puerta de tu casa."
    },
    {
      icon: Heart,
      title: "Cuidado Consciente",
      text: "Fórmulas dermatológicamente probadas, libres de crueldad animal y parabenos."
    }
  ];
    ...
    <section className="py-20 bg-white relative overflow-hidden">
      <div className="container px-4">
        ...
        >
          ...
          <p className="text-main-muted">En Zento no solo vendemos una crema, entregamos confianza y resultados. Estamos contigo en cada paso de tu transformación.</p>
        </motion.div>
