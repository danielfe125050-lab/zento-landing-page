    ...
    <section className="py-24 bg-surface-light/30 border-y border-gray-100">
      <div className="container px-4 max-w-6xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-500 font-medium leading-relaxed">Olvídate de exprimir a mano, ensuciar tu cocina entera o dañar tus muñecas. Su motor rotativo hace el trabajo duro por ti.</p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-4xl mx-auto">
            <motion.div whileHover={{ y: -5 }} className="p-8 bg-white rounded-3xl shadow-lg border border-primary/5">
                <p className="text-primary font-black text-5xl mb-2">100%</p>
                <p className="text-main text-sm uppercase font-bold tracking-widest">Natural y Sano</p>
                <p className="text-gray-400 text-xs mt-2 font-medium">Conserva las vitaminas de la fruta real</p>
            </motion.div>
            <motion.div whileHover={{ y: -5 }} className="p-8 bg-white rounded-3xl shadow-lg border border-primary/5 relative scale-105 z-10 border-b-4 border-b-primary shadow-primary/10">
                ...
                <p className="text-main text-sm uppercase font-bold tracking-widest">Desorden / Cables</p>
                <p className="text-gray-400 text-xs mt-2 font-medium">No salpica y es totalmente portátil</p>
            </motion.div>
            <motion.div whileHover={{ y: -5 }} className="p-8 bg-white rounded-3xl shadow-lg border border-primary/5">
                <p className="text-primary font-black text-5xl mb-2">30</p>
                <p className="text-main text-sm uppercase font-bold tracking-widest">Segundos</p>
                <p className="text-gray-400 text-xs mt-2 font-medium">Tiempo récord de limpieza total</p>
            </motion.div>
        </div>
      </div>
    </section>
