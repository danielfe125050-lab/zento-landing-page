...
const replacements = [
  ...
  [/ha sido diseñado por atletas para atletas, entendiendo que el agarre perfecto requiere protección total y ergonomía/g, 'ha sido diseñado para la mujer práctica, entendiendo que la belleza requiere soluciones veloces, sin dolor y efectivas'],
